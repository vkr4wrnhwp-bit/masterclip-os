...
| Disk durability | Render snapshots `/var/data` automatically every 24 hours, encrypted, kept at least seven days. Restore is whole-disk from the service's Disks page — see risk #23 for what that does and does not cover |
